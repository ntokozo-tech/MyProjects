                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="service-item rounded pt-3" style="background-color: white; height: 150px; width: 320px;">
                            <div class="p-4">
                                ...
                                <div class="icon-container">
                                    <h3>
                                        <asp:Label ID="dialyLbl" runat="server" Text=""></asp:Label></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="service-item rounded pt-3" style="background-color: white; height: 150px; width: 320px;">
                            <div class="p-4">
                                ...
                                <div class="icon-container">
                                    <h3>
                                        <asp:Label ID="usersLbl" runat="server" Text=""></asp:Label></h3>
                                </div>
                                <div class="icon-container">
                                    <p style="color: green">New today:
                        ...
                        <div class="service-item rounded pt-3" style="background-color: white; height: 150px; width: 320px;">
                            <div class="p-4">
                                ...
                                <div class="icon-container">
                                    ...
                                    <h3>
                                        <asp:Label ID="ItemCountLabel" runat="server" Text=""></asp:Label></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container2" style="height: 500px; width: 300px">
                        ...
                        <div style="display: flex; align-items: center;">
                            ...
                            <div style="margin-left: 20px;">
                                <h4>
                                    <asp:Label ID="mostBoughtLabel" runat="server" Text=""></asp:Label></h4>
                                <h5>
                                    <asp:Label ID="mostBoughtCountLabel" runat="server" Text=""></asp:Label></h5>
                            </div>
                        </div>
