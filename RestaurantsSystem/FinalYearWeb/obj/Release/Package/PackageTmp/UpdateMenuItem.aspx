<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateMenuItem.aspx.cs" Inherits="FinalYearWeb.UpdateMenuItem" EnableEventValidation="false" Async="true"%>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-6 bg-dark d-flex align-items-center">
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        <h1 class="text-white mb-4">Update Menu Item</h1>
                        <form id="addForm" runat="server">
                                <div class="modal-body">
                                
                                  <div class="mb-3">
                                       <asp:TextBox  ID="nameUpdate" Width="550px" Height="40px" placeholder="Item name" ForeColor="Gray" BorderColor="Gray"    runat="server"></asp:TextBox>
                                  </div>

                                   <div class="mb-3">
                                       <asp:TextBox     Width="550px" Height="40px"  id="descriptionUpdate" type="text"   placeholder="Item description" ForeColor="Gray" BorderColor="Gray"    runat="server"></asp:TextBox>
                                   </div>
                                   ...
                                   <div class="mb-3">
                                       <asp:TextBox   Width="550px" Height="40px" id="priceUpdate" type="text"  placeholder="Item price" ForeColor="Gray" BorderColor="Gray"    runat="server"></asp:TextBox>
                                        
                                   </div>
                                   <div class="mb-3">
                                       <!--<asp:TextBox   Width="550px" Height="40px" id="categoryUpdate" type="text"  placeholder="Item category" ForeColor="Gray" BorderColor="Gray"    runat="server"></asp:TextBox>-->
                                       <asp:DropDownList ID="categoryList" runat="server">
                                        <asp:ListItem Text="Breakfast" Value="breakfast"></asp:ListItem>
                                        <asp:ListItem Text="Lunch" Value="lunch"></asp:ListItem>
                                        <asp:ListItem Text="Dessertt" Value="dessert"></asp:ListItem>
