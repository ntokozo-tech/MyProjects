<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateSpecials.aspx.cs" Inherits="FinalYearWeb.CreateSpecials" EnableEventValidation="false" Async="true" %>
...
<li><a href="StoreSales.aspx">Sales</a></li> 
    ...
    <br />
        ...
        <div class="container-xxl py-5 px-0 wow fadeInUp" data-wow-delay="0.1s">
            <div class="row g-0">
                <div class="col-md-6">
                    <div class="video" id="updateSpecial" runat="server">

                    </div>
                </div>
                <div class="col-md-6 bg-dark d-flex align-items-center">
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        <h1 class="text-white mb-4">Put On Specials</h1>
                        <form id="addForm" runat="server">
                            <div class="modal-body">
                                ...
                                <div class="modal-body">
                                   <div class="mb-3">
                                       <asp:TextBox   Width="550px" Height="40px" id="priceSpecial" type="text"  placeholder="Item price" ForeColor="Gray" BorderColor="Gray"    runat="server"></asp:TextBox>
                                   </div>
                                 <div class="mb-3">
                                     <asp:Button ID="Button3" runat="server" BackColor="#008000" Width="550px" Height="50px" ForeColor="Black" Text="Submit" OnClick="btnCreateSpecials" />
                                </div>
