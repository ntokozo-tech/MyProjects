<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteEmployee.aspx.cs" Inherits="FinalYearWeb.DeleteEmployee" Async="true"%>
<!DOCTYPE html>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-6 bg-dark d-flex align-items-center">
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        <h1 class="text-white mb-4">Remove Employee</h1>
                        
                            
                                <div class="modal-body">
                                     <div class="mb-3">
                                         <asp:Button ID="Button2" runat="server" Text="Remove Employee" BackColor="#FF0000" AutoPostBack ="true" Width="550px" Height="50px" ForeColor="Black" OnClick="btnDelete"/>
