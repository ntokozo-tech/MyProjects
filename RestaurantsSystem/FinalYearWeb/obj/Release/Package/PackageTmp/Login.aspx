<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="FinalYearWeb.Login" Async="true" %>
...
<div class="row justify-content-center">
        <div class="container1" style="background-color: white;  width: 600px; height:400px; padding:20px">
    <h3 style=" font-size: 50px;font-weight: bold;">Welcome To Pino's</h3>
    <div>
       <img src="images/burger.gif" alt="Animated GIF" width="450" height="350">
...
<div class="modal-body">
    <form id="form1" runat="server">
      <div class="mb-3">
           <asp:TextBox  id="email" required="true" runat="server" type="email"   placeholder="User Name"  Width="60%"  ForeColor="Gray" BorderColor="Gray"   ></asp:TextBox>
</div>
           <div class="mb-3">
        ...
        <asp:Button runat="server" OnClick="login_Click" BackColor="green" text-align="left"   Width="60%" ForeColor="Black"  Text="Login" ID="login" />
               <div class="mb-3">
                   <asp:HyperLink ID="HyperLink1" ForeColor="green" runat="server" NavigateUrl="~/Register.aspx">Create an account</asp:HyperLink> </br></br>
                    <asp:HyperLink ID="HyperLink2" ForeColor="red" runat="server" NavigateUrl="~/ResetPassword.aspx">Forgot password?</asp:HyperLink></br></br>
