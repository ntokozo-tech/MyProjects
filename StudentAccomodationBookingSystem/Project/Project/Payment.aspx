                                ...
                                <div id="credit-card" class="tab-pane fade show active pt-3">
                                    <form role="form" onsubmit="event.preventDefault()">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input id="Amount" runat="server" name="Amount" placeholder="Enter the payment amount" class="form-control " required>
                                                <%--<div class="input-group-append"><span class="input-group-text text-muted"><i class="fab fa-cc-visa mx-1"></i><i class="fab fa-cc-mastercard mx-1"></i><i class="fab fa-cc-amex mx-1"></i></span></div>--%>
                                            </div>
                                        </div>
                                        <%--<div class="card-footer">
                                            <button type="button" class="subscribe btn btn-primary btn-block shadow-sm">Confirm Payment </button>--%>
                                        <asp:Button ID="Button1" runat="server" Text="Confirm payment" onClick ="btnConfirm"/>
                                    </form>
                                </div>
                            </div>
                            <!-- End -->
